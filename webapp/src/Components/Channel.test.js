  ...
  describe('Delete button', () => {
    describe('When current user is owner of the message', () => {
      it('Should show delete button', async done => {
        ...
        const wrapper = mount(
          <Channel channelId={1} currentUser={{ id: 1 }} />
        ); // componentDidMount will be called after initial rendering//  1-> c'est le "mount" qui fait un réel appel cf channel l70. 2-le fetchMock l'intercept car c'est la même route et lui rend des données fictives car c'est un mock.
        setImmediate(() => {
